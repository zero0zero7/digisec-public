...
ROOTFS_FULL="${chroot_base}/firecracker/${VM_ID}/root/rorootfs.ext4"
...
sudo cp "${chroot_base}/rw.ext4" "${chroot_base}/firecracker/${VM_ID}/root/rw.ext4"
sudo chmod 666 -R  "${chroot_base}/firecracker/${VM_ID}/root/rw.ext4"
...
sudo curl -X PUT --unix-socket "${API_SOCKET}" \
    ...
    "http://localhost/drives/rorootfs"
printf "\n curled roROOTFS\n"
